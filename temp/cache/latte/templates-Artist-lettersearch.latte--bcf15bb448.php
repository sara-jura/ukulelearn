<?php
// source: C:\xampp\htdocs\ukulelearn\app\presenters/templates/Artist/lettersearch.latte

use Latte\Runtime as LR;

class Templatebcf15bb448 extends Latte\Runtime\Template
{
	public $blocks = [
...
<?php
		...
		foreach ($artists as $u) {
			...
			echo LR\Filters::escapeHtmlText($u->name) /* line 12 */ ?></a></li>
<?php
			$iterations++;
		}
		?></ul><?php
