...
class Container_b4bdf6fb00 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\BaseModel' => [1 => ['artist_model', 'base_model']],
			'Nette\Object' => [1 => ['artist_model', 'base_model']],
			'App\Model\ArtistModel' => [1 => ['artist_model']],
		...
		'services' => [
			...
			'artist_model' => 'App\Model\ArtistModel',
			'base_model' => 'App\Model\BaseModel',
	...
	/**
	 * @return App\Model\ArtistModel
	 */
	public function createServiceArtist_model()
	{
		$service = new App\Model\ArtistModel($this->getService('database.default.context'),
			$this->getService('artist_model'));
		return $service;
	}
	 ...
	 */
	public function createServiceBase_model()
	{
		$service = new App\Model\BaseModel($this->getService('database.default.context'), $this->getService('artist_model'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=ukulelearn', 'root',
			NULL, ['lazy' => TRUE]);
