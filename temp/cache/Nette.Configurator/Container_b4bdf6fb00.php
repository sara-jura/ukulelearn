<?php
// source: C:\xampp\htdocs\ukulelearn\app/config/config.neon 
// source: C:\xampp\htdocs\ukulelearn\app/config/config.local.neon 

class Container_b4bdf6fb00 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'Nette\Object' => [
				...
				[
					...
					'translation.loader',
					'111_App_Forms_ChordForm',
					'112_App_Forms_LoginForm',
					'113_App_Forms_SongForm',
					'114_App_Forms_UserForm',
					'115_App_Model_ArtistRepository',
					'116_App_Model_Authenticator',
					'117_App_Model_ChordRepository',
					'118_App_Model_SongRepository',
					'119_App_Model_UserRepository',
				],
			],
			...
			'App\Forms\ChordForm' => [1 => ['111_App_Forms_ChordForm']],
			'App\Forms\LoginForm' => [1 => ['112_App_Forms_LoginForm']],
			'App\Forms\SongForm' => [1 => ['113_App_Forms_SongForm']],
			'App\Forms\UserForm' => [1 => ['114_App_Forms_UserForm']],
			'App\Model\ArtistRepository' => [1 => ['115_App_Model_ArtistRepository']],
			'Nette\Security\IAuthenticator' => [1 => ['116_App_Model_Authenticator']],
			'App\Model\Authenticator' => [1 => ['116_App_Model_Authenticator']],
			'App\Model\ChordRepository' => [1 => ['117_App_Model_ChordRepository']],
			'App\Model\SongRepository' => [1 => ['118_App_Model_SongRepository']],
			'App\Model\UserRepository' => [1 => ['119_App_Model_UserRepository']],
			'App\Presenters\BasePresenter' => [
				1 => [
					'120_App_Presenters_LoginPresenter',
					'application.1',
					'application.2',
					'application.3',
					'application.5',
			...
			'App\Presenters\LoginPresenter' => [1 => ['120_App_Presenters_LoginPresenter']],
			...
			'App\Presenters\SongPresenter' => [1 => ['application.6']],
		...
		'services' => [
			'111_App_Forms_ChordForm' => 'App\Forms\ChordForm',
			'112_App_Forms_LoginForm' => 'App\Forms\LoginForm',
			'113_App_Forms_SongForm' => 'App\Forms\SongForm',
			'114_App_Forms_UserForm' => 'App\Forms\UserForm',
			'115_App_Model_ArtistRepository' => 'App\Model\ArtistRepository',
			'116_App_Model_Authenticator' => 'App\Model\Authenticator',
			'117_App_Model_ChordRepository' => 'App\Model\ChordRepository',
			'118_App_Model_SongRepository' => 'App\Model\SongRepository',
			'119_App_Model_UserRepository' => 'App\Model\UserRepository',
			'120_App_Presenters_LoginPresenter' => 'App\Presenters\LoginPresenter',
			...
			'application.6' => 'App\Presenters\SongPresenter',
		...
		'tags' => [
			'inject' => [
				'120_App_Presenters_LoginPresenter' => TRUE,
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\ukulelearn\app',
			'wwwDir' => 'C:\xampp\htdocs\ukulelearn\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\xampp\htdocs\ukulelearn\app/../temp',
	 ...
	 */
	public function createService__111_App_Forms_ChordForm()
	{
		$service = new App\Forms\ChordForm($this->getService('doctrine.default.entityManager'),
			$this->getService('118_App_Model_SongRepository'), $this->getService('115_App_Model_ArtistRepository'));
		return $service;
	}
	 ...
	 */
	public function createService__112_App_Forms_LoginForm()
	{
		$service = new App\Forms\LoginForm($this->getService('security.user'), $this->getService('116_App_Model_Authenticator'));
		return $service;
	}
	 ...
	 */
	public function createService__113_App_Forms_SongForm()
	{
	 ...
	 */
	public function createService__114_App_Forms_UserForm()
	{
		$service = new App\Forms\UserForm($this->getService('119_App_Model_UserRepository'),
	 ...
	 */
	public function createService__115_App_Model_ArtistRepository()
	{
	 ...
	 */
	public function createService__116_App_Model_Authenticator()
	{
		$service = new App\Model\Authenticator($this->getService('119_App_Model_UserRepository'));
		return $service;
	}
	 ...
	 */
	public function createService__117_App_Model_ChordRepository()
	{
	 ...
	 */
	public function createService__118_App_Model_SongRepository()
	{
	 ...
	 */
	public function createService__119_App_Model_UserRepository()
	{
	 ...
	 */
	public function createService__120_App_Presenters_LoginPresenter()
	{
		...
		$service->loginManager = $this->getService('112_App_Forms_LoginForm');
	...
	public function createServiceAnnotations__cache__annotations()
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Annotations',
			TRUE);
		$service->setNamespace('Kdyby_annotations.cache.annotations_f4a398eb');
		return $service;
	}
	...
	/**
	 * @return App\Presenters\ArtistPresenter
	 */
	public function createServiceApplication__1()
	{
		...
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			...
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->injectDependencies($this->getService('115_App_Model_ArtistRepository'),
			$this->getService('118_App_Model_SongRepository'));
		$service->invalidLinkMode = 5;
	...
	/**
	 * @return App\Presenters\ChordPresenter
	 */
	public function createServiceApplication__2()
	{
		...
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			...
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->injectDependencies($this->getService('115_App_Model_ArtistRepository'),
			$this->getService('118_App_Model_SongRepository'), $this->getService('117_App_Model_ChordRepository'),
			$this->getService('111_App_Forms_ChordForm'));
		$service->invalidLinkMode = 5;
	...
	/**
	 * @return App\Presenters\SongPresenter
	 */
	public function createServiceApplication__6()
	{
		...
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			...
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->injectDependencies($this->getService('115_App_Model_ArtistRepository'),
			$this->getService('118_App_Model_SongRepository'), $this->getService('113_App_Forms_SongForm'));
		$service->invalidLinkMode = 5;
	...
	public function createServiceApplication__7()
	{
		...
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			...
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->injectUserForm($this->getService('114_App_Forms_UserForm'));
		$service->invalidLinkMode = 5;
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\ukulelearn\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\ukulelearn\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__dbalResult()
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Default.dbalResult',
			FALSE);
		$service->setNamespace('Kdyby_doctrine.cache.default.dbalResult_f4a398eb');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__hydration()
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Default.hydration',
			FALSE);
		$service->setNamespace('Kdyby_doctrine.cache.default.hydration_f4a398eb');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__metadata()
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Default.metadata',
			FALSE);
		$service->setNamespace('Kdyby_doctrine.cache.default.metadata_f4a398eb');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__ormResult()
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Default.ormResult',
			FALSE);
		$service->setNamespace('Kdyby_doctrine.cache.default.ormResult_f4a398eb');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__query()
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Default.query',
			FALSE);
		$service->setNamespace('Kdyby_doctrine.cache.default.query_f4a398eb');
		return $service;
	}
	...
	{
		return new Container_b4bdf6fb00_Kdyby_Doctrine_EntityDaoFactoryImpl_doctrine_daoFactory($this);
	}
	...
	{
		$service = new Kdyby\Doctrine\Mapping\AnnotationDriver(['C:\xampp\htdocs\ukulelearn\app'],
	...
	public function createServiceDoctrine__default__driver__Kdyby_Doctrine__annotationsImpl()
	{
		$service = new Kdyby\Doctrine\Mapping\AnnotationDriver([
			'C:\xampp\htdocs\ukulelearn\vendor\kdyby\doctrine\src\Kdyby\Doctrine\DI/../Entities',
		], $this->getService('annotations.reader'), $this->getService('doctrine.cache.default.metadata'));
		return $service;
	}
	...
	public function createServiceDoctrine__default__ormConfiguration()
	{
		...
		$service->setProxyDir('C:\xampp\htdocs\ukulelearn\app/../temp/proxies');
	...
	{
		return new Container_b4bdf6fb00_Kdyby_Doctrine_DI_IRepositoryFactoryImpl_doctrine_repositoryFactory_default_defaultRepositoryFactory($this);
	}
	...
	{
		return new Container_b4bdf6fb00_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	{
		$service = new Nette\Security\User($this->getService('security.userStorage'), $this->getService('116_App_Model_Authenticator'));
	...
	{
		$service = new Kdyby\Translation\CatalogueCompiler(new Kdyby\Translation\Caching\PhpFileStorage('C:\xampp\htdocs\ukulelearn\app/../temp/cache',
	...
	public function createServiceTranslation__console__extract()
	{
		...
		$service->defaultOutputDir = 'C:\xampp\htdocs\ukulelearn\app/lang';
		return $service;
	}
	...
	public function createServiceTranslation__default()
	{
		...
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.af.xlf',
			'af', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.ar.xlf',
			'ar', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.az.xlf',
			'az', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.bg.xlf',
			'bg', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.ca.xlf',
			'ca', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.cs.xlf',
			'cs', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.cy.xlf',
			'cy', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.da.xlf',
			'da', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.de.xlf',
			'de', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.el.xlf',
			'el', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.en.xlf',
			'en', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.es.xlf',
			'es', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.et.xlf',
			'et', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.eu.xlf',
			'eu', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.fa.xlf',
			'fa', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.fi.xlf',
			'fi', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.fr.xlf',
			'fr', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.gl.xlf',
			'gl', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.he.xlf',
			'he', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.hr.xlf',
			'hr', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.hu.xlf',
			'hu', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.hy.xlf',
			'hy', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.id.xlf',
			'id', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.it.xlf',
			'it', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.ja.xlf',
			'ja', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.lb.xlf',
			'lb', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.lt.xlf',
			'lt', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.lv.xlf',
			'lv', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.mn.xlf',
			'mn', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.nl.xlf',
			'nl', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.nn.xlf',
			'nn', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.no.xlf',
			'no', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.pl.xlf',
			'pl', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.pt.xlf',
			'pt', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.pt_BR.xlf',
			'pt_BR', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.ro.xlf',
			'ro', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.ru.xlf',
			'ru', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.sk.xlf',
			'sk', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.sl.xlf',
			'sl', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.sq.xlf',
			'sq', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.sr_Cyrl.xlf',
			'sr_Cyrl', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.sr_Latn.xlf',
			'sr_Latn', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.sv.xlf',
			'sv', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.th.xlf',
			'th', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.tr.xlf',
			'tr', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.uk.xlf',
			'uk', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.vi.xlf',
			'vi', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.zh_CN.xlf',
			'zh_CN', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\ukulelearn\vendor\symfony\validator/Resources/translations\validators.zh_TW.xlf',
			'zh_TW', 'validators');
		return $service;
	}
	...
	{
		$service = new Kdyby\Translation\Diagnostics\Panel('C:\xampp\htdocs\ukulelearn');
		$service->setLocaleWhitelist(NULL);
	...
	public function createServiceValidator__cache__validator()
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Validator',
			TRUE);
		$service->setNamespace('Kdyby_validator.cache.validator_f4a398eb');
		return $service;
	}
	...
	{
		Kdyby\Doctrine\Proxy\ProxyAutoloader::create('C:\xampp\htdocs\ukulelearn\app/../temp/proxies', 'Kdyby\GeneratedProxy')->register();Doctrine\Common\Annotations\AnnotationRegistry::registerLoader("class_exists");
		...
		Tracy\Debugger::getBlueScreen()->collapsePaths[] = 'C:\xampp\htdocs\ukulelearn\vendor\kdyby\doctrine\src\Kdyby\Doctrine';
		Tracy\Debugger::getBlueScreen()->collapsePaths[] = 'C:\xampp\htdocs\ukulelearn\vendor\doctrine';
		Tracy\Debugger::getBlueScreen()->collapsePaths[] = 'C:\xampp\htdocs\ukulelearn\app/../temp/proxies';
...
class Container_b4bdf6fb00_Kdyby_Doctrine_EntityDaoFactoryImpl_doctrine_daoFactory implements Kdyby\Doctrine\EntityDaoFactory
{
	private $container;


	public function __construct(Container_b4bdf6fb00 $container)
	{
...
class Container_b4bdf6fb00_Kdyby_Doctrine_DI_IRepositoryFactoryImpl_doctrine_repositoryFactory_default_defaultRepositoryFactory implements Kdyby\Doctrine\DI\IRepositoryFactory
{
	private $container;
...
class Container_b4bdf6fb00_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\xampp\htdocs\ukulelearn\app/../temp/cache/latte');
