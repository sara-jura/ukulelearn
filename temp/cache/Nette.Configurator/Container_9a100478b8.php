...
class Container_9a100478b8 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'Nette\Object' => [
				...
				[
					...
					'translation.loader',
					'115_App_Forms_SongForm',
					'116_App_Model_ArtistRepository',
					'117_App_Model_SongRepository',
				],
			],
			...
			'App\Forms\SongForm' => [1 => ['115_App_Forms_SongForm']],
			'App\Model\ArtistRepository' => [1 => ['116_App_Model_ArtistRepository']],
			'App\Model\SongRepository' => [1 => ['117_App_Model_SongRepository']],
		...
		'services' => [
			'115_App_Forms_SongForm' => 'App\Forms\SongForm',
			'116_App_Model_ArtistRepository' => 'App\Model\ArtistRepository',
			'117_App_Model_SongRepository' => 'App\Model\SongRepository',
	 ...
	 */
	public function createService__115_App_Forms_SongForm()
	{
		$service = new App\Forms\SongForm($this->getService('doctrine.default.entityManager'),
			$this->getService('117_App_Model_SongRepository'), $this->getService('116_App_Model_ArtistRepository'));
		return $service;
	}
	 ...
	 */
	public function createService__116_App_Model_ArtistRepository()
	{
	 ...
	 */
	public function createService__117_App_Model_SongRepository()
	{
	...
	public function createServiceAnnotations__cache__annotations()
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Annotations',
			FALSE);
		$service->setNamespace('Kdyby_annotations.cache.annotations_21b47e80');
		return $service;
	}
	...
	public function createServiceApplication__1()
	{
		...
		$service->injectDependencies($this->getService('116_App_Model_ArtistRepository'),
			$this->getService('117_App_Model_SongRepository'));
	...
	public function createServiceApplication__5()
	{
		...
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			...
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->injectDependencies($this->getService('116_App_Model_ArtistRepository'),
			$this->getService('117_App_Model_SongRepository'), $this->getService('115_App_Forms_SongForm'));
		$service->invalidLinkMode = 1;
	...
	public function createServiceDoctrine__cache__default__dbalResult()
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Default.dbalResult',
			FALSE);
		$service->setNamespace('Kdyby_doctrine.cache.default.dbalResult_21b47e80');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__hydration()
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Default.hydration',
			FALSE);
		$service->setNamespace('Kdyby_doctrine.cache.default.hydration_21b47e80');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__metadata()
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Default.metadata',
			FALSE);
		$service->setNamespace('Kdyby_doctrine.cache.default.metadata_21b47e80');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__ormResult()
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Default.ormResult',
			FALSE);
		$service->setNamespace('Kdyby_doctrine.cache.default.ormResult_21b47e80');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__query()
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Default.query',
			FALSE);
		$service->setNamespace('Kdyby_doctrine.cache.default.query_21b47e80');
		return $service;
	}
	...
	{
		return new Container_9a100478b8_Kdyby_Doctrine_EntityDaoFactoryImpl_doctrine_daoFactory($this);
	}
	...
	{
		$service = new Kdyby\Doctrine\Mapping\AnnotationDriver(['C:\xampp\htdocs\sandbox\app'],
	...
	public function createServiceDoctrine__default__driver__Kdyby_Doctrine__annotationsImpl()
	{
		$service = new Kdyby\Doctrine\Mapping\AnnotationDriver([
			'C:\xampp\htdocs\sandbox\vendor\kdyby\doctrine\src\Kdyby\Doctrine\DI/../Entities',
		], $this->getService('annotations.reader'), $this->getService('doctrine.cache.default.metadata'));
		return $service;
	}
	...
	public function createServiceDoctrine__default__ormConfiguration()
	{
		...
		$service->setProxyDir('C:\xampp\htdocs\sandbox\app/../temp/proxies');
	...
	{
		return new Container_9a100478b8_Kdyby_Doctrine_DI_IRepositoryFactoryImpl_doctrine_repositoryFactory_default_defaultRepositoryFactory($this);
	}
	...
	{
		return new Container_9a100478b8_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceTranslation__console__extract()
	{
		...
		$service->defaultOutputDir = 'C:\xampp\htdocs\sandbox\app/lang';
		return $service;
	}
	...
	public function createServiceTranslation__default()
	{
		...
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.af.xlf',
			'af', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.ar.xlf',
			'ar', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.az.xlf',
			'az', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.bg.xlf',
			'bg', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.ca.xlf',
			'ca', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.cs.xlf',
			'cs', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.cy.xlf',
			'cy', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.da.xlf',
			'da', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.de.xlf',
			'de', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.el.xlf',
			'el', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.en.xlf',
			'en', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.es.xlf',
			'es', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.et.xlf',
			'et', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.eu.xlf',
			'eu', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.fa.xlf',
			'fa', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.fi.xlf',
			'fi', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.fr.xlf',
			'fr', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.gl.xlf',
			'gl', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.he.xlf',
			'he', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.hr.xlf',
			'hr', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.hu.xlf',
			'hu', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.hy.xlf',
			'hy', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.id.xlf',
			'id', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.it.xlf',
			'it', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.ja.xlf',
			'ja', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.lb.xlf',
			'lb', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.lt.xlf',
			'lt', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.lv.xlf',
			'lv', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.mn.xlf',
			'mn', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.nl.xlf',
			'nl', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.nn.xlf',
			'nn', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.no.xlf',
			'no', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.pl.xlf',
			'pl', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.pt.xlf',
			'pt', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.pt_BR.xlf',
			'pt_BR', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.ro.xlf',
			'ro', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.ru.xlf',
			'ru', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.sk.xlf',
			'sk', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.sl.xlf',
			'sl', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.sq.xlf',
			'sq', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.sr_Cyrl.xlf',
			'sr_Cyrl', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.sr_Latn.xlf',
			'sr_Latn', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.sv.xlf',
			'sv', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.th.xlf',
			'th', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.tr.xlf',
			'tr', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.uk.xlf',
			'uk', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.vi.xlf',
			'vi', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.zh_CN.xlf',
			'zh_CN', 'validators');
		$service->addResource('xlf', 'C:\xampp\htdocs\sandbox\vendor\symfony\validator/Resources/translations\validators.zh_TW.xlf',
			'zh_TW', 'validators');
		return $service;
	}
	...
	public function createServiceValidator__cache__validator()
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Validator',
			FALSE);
		$service->setNamespace('Kdyby_validator.cache.validator_21b47e80');
		return $service;
	}
	...
	{
		Kdyby\Doctrine\Proxy\ProxyAutoloader::create('C:\xampp\htdocs\sandbox\app/../temp/proxies', 'Kdyby\GeneratedProxy')->register();Doctrine\Common\Annotations\AnnotationRegistry::registerLoader("class_exists");
		...
		Tracy\Debugger::getBlueScreen()->collapsePaths[] = 'C:\xampp\htdocs\sandbox\vendor\kdyby\doctrine\src\Kdyby\Doctrine';
		Tracy\Debugger::getBlueScreen()->collapsePaths[] = 'C:\xampp\htdocs\sandbox\vendor\doctrine';
		Tracy\Debugger::getBlueScreen()->collapsePaths[] = 'C:\xampp\htdocs\sandbox\app/../temp/proxies';
...
class Container_9a100478b8_Kdyby_Doctrine_EntityDaoFactoryImpl_doctrine_daoFactory implements Kdyby\Doctrine\EntityDaoFactory
{
	private $container;


	public function __construct(Container_9a100478b8 $container)
	{
...
class Container_9a100478b8_Kdyby_Doctrine_DI_IRepositoryFactoryImpl_doctrine_repositoryFactory_default_defaultRepositoryFactory implements Kdyby\Doctrine\DI\IRepositoryFactory
{
	private $container;
...
class Container_9a100478b8_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;
