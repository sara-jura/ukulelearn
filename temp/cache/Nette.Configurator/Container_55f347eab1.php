<?php
// source: C:\xampp\htdocs\ukulelearn3\app/config/config.neon 
// source: C:\xampp\htdocs\ukulelearn3\app/config/config.local.neon 

class Container_55f347eab1 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\ukulelearn3\app',
			'wwwDir' => 'C:\xampp\htdocs\ukulelearn3\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => TRUE,
			'tempDir' => 'C:\xampp\htdocs\ukulelearn3\app/../temp',
	...
	public function createServiceApplication__2()
	{
		...
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			...
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->injectDependencies($this->getService('chordrepository'), $this->getService('chordform'));
		$service->invalidLinkMode = 5;
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\ukulelearn3\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\ukulelearn3\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\ukulelearn3\app/../temp/cache',
	...
	public function createServiceConsole__application()
	{
		...
		$service->setDispatcher($this->getService('events.symfonyProxy'));
		return $service;
	}
	...
	{
		return new Container_55f347eab1_Kdyby_Doctrine_EntityDaoFactoryImpl_doctrine_daoFactory($this);
	}
	...
	{
		$service = new Kdyby\Doctrine\Mapping\AnnotationDriver(['C:\xampp\htdocs\ukulelearn3\app'],
	...
	public function createServiceDoctrine__default__ormConfiguration()
	{
		...
		$service->setProxyDir('C:\xampp\htdocs\ukulelearn3\app/../temp/proxies');
	...
	{
		return new Container_55f347eab1_Kdyby_Doctrine_DI_IRepositoryFactoryImpl_doctrine_repositoryFactory_default_defaultRepositoryFactory($this);
	}
	...
	{
		return new Container_55f347eab1_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	{
		$service = new Kdyby\Translation\CatalogueCompiler(new Kdyby\Translation\Caching\PhpFileStorage('C:\xampp\htdocs\ukulelearn3\app/../temp/cache',
	...
	public function createServiceTranslation__console__extract()
	{
		...
		$service->defaultOutputDir = 'C:\xampp\htdocs\ukulelearn3\app/lang';
		return $service;
	}
	...
	{
		$service = new Kdyby\Translation\Diagnostics\Panel('C:\xampp\htdocs\ukulelearn3');
		$service->setLocaleWhitelist(NULL);
	...
	{
		Kdyby\Doctrine\Proxy\ProxyAutoloader::create('C:\xampp\htdocs\ukulelearn3\app/../temp/proxies', 'Kdyby\GeneratedProxy')->register();Doctrine\Common\Annotations\AnnotationRegistry::registerLoader("class_exists");
		...
		Tracy\Debugger::getBlueScreen()->collapsePaths[] = 'C:\xampp\htdocs\ukulelearn3\app/../temp/proxies';
...
class Container_55f347eab1_Kdyby_Doctrine_EntityDaoFactoryImpl_doctrine_daoFactory implements Kdyby\Doctrine\EntityDaoFactory
{
	private $container;


	public function __construct(Container_55f347eab1 $container)
	{
...
class Container_55f347eab1_Kdyby_Doctrine_DI_IRepositoryFactoryImpl_doctrine_repositoryFactory_default_defaultRepositoryFactory implements Kdyby\Doctrine\DI\IRepositoryFactory
{
	private $container;
...
class Container_55f347eab1_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\xampp\htdocs\ukulelearn3\app/../temp/cache/latte');
